...
<head>
<title>Blog Tajmahal cost</title>
...
<div class="wrapper">
  <div class="container">
    		<h1>How much does Taj Mahal cost</h1>
  ...
  <div class = "container">
	...
	<div class="fb-comments" data-href="http://gogogoru.com/v2/blog/fun-blogs/facts/taj-mahal-cost.php" data-numposts="5"></div>
</div>
</div>
...
<div class="wrapper">
  ...
  <div id="hpage_cats">
    <div class="fl_left">
      ...
      <img src="../images/Globe_of_language.png" width = "100px" height = "100px" alt="" />
    ...
    <div class="fl_right">
      ...
      <img src="../images/body.jpg" width = "100px" height = "100px" alt="" />
    ...
    <div class="fl_left">
      ...
      <img src="../images/taj-mahal.jpg" width = "100px" height = "100px" alt="" />
    ...
    <div class="fl_right">
      ...
      <img src="../images/youtube.png" width = "100px" height = "100px"  alt="" />
  ...
  <div class="container">
    <div class="content">
      <div id="hpage_latest">
        ...
        <ul>
          <li><img src="../images/opera-singer.png" width = "190" height = "130" alt="" />
          ...
          <li><img src="../images/ramesh-babu.jpg" width = "190" height = "130" alt="" />
            <h2>Barber owns Rolls Royce</h2>
            <p>An Indian Millionare Barber owns a Rolls Royce! Listen to his story..</p>
            <p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
          </li>
          <li class="last"><img src="../images/deadly-spider.jpg" width = "190" height = "130" alt="" />
